...
gcn_b01616_ybrh2si2_lda_inadequate_dynamic_correlations = claim(
...
gcn_34ce9_ybrh2si2_many_body_methods_required = claim(
...
strat_gfac_9d14afa95eda494a_many_body_methods = deduction(
