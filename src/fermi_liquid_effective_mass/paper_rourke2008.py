...
gcn_848945_ybrh2si2_lusmall_fs_lda_assumption = claim(
...
gcn_5090f8_dhva_orbit_assignment_reliability = claim(
...
gcn_d10f91_ybrh2si2_small_fs_mass_enhancement = claim(
...
strat_gfac_7960d27e3ad54880_small_fs_mass_enhancement = deduction(
    [
