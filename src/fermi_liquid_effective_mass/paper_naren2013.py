...
ybrh2si2_hall_compensation_scenario = claim(
...
ybrh2si2_thermopower_lifshitz_corroboration = claim(
...
ybrh2si2_lifshitz_derenormalization = claim(
...
derive_ybrh2si2_lifshitz_derenormalization = deduction(
    [
