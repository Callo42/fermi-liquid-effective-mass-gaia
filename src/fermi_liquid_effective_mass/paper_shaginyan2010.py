...
landau_mass_integral_relation = claim(
...
homogeneous_isotropic_heavy_liquid_model = claim(
...
fcqpt_inflection_critical_condition = claim(
...
stable_landau_numerical_solutions = claim(
...
entropy_over_temperature_mass_proxy = claim(
...
ybrh2si2_entropy_effective_mass_scheme = claim(
...
derive_ybrh2si2_entropy_effective_mass_scheme = deduction(
    [
