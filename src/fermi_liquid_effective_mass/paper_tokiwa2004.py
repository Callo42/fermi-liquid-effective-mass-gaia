...
high_field_a_gamma_scaling_assumption = claim(
...
ybrh2si2_t2_resistivity_fit_reliability = claim(
...
ybrh2si2_resistivity_mass_drop = claim(
...
derive_ybrh2si2_resistivity_mass_drop = deduction(
    [
