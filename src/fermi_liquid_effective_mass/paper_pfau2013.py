...
ybrh2si2_cef_anisotropic_hybridization = claim(
...
ybrh2si2_smooth_kondo_mass_suppression = claim(
...
periodic_kondo_lattice_lifshitz_dos = claim(
...
ybrh2si2_kondo_lifshitz_interplay = claim(
...
derive_ybrh2si2_kondo_lifshitz_interplay = deduction(
    [
