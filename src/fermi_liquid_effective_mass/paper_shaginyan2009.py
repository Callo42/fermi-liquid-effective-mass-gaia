...
fcqpt_cubic_spectrum_condition = claim(
...
fcqpt_homogeneous_mass_equation = claim(
...
fcqpt_t_minus_two_thirds_mass_scaling = claim(
...
derive_fcqpt_t_minus_two_thirds_mass_scaling = deduction(
    [
